...
export function ProductCard({
  ...
  return (
    <Card
      shadow="none"
      className="h-full border border-default-100 hover:border-primary/30 hover:shadow-2xl transition-all duration-300 bg-background rounded-[2rem] overflow-hidden group"
    >
      <CardBody className="p-0 flex flex-col h-full overflow-hidden">
        ...
        <div className="relative aspect-[4/5] bg-default-50 flex items-center justify-center overflow-hidden">
          ...
          <div className="absolute inset-x-0 bottom-4 px-4 z-30 flex justify-center gap-2 opacity-0 translate-y-2 group-hover:opacity-100 group-hover:translate-y-0 transition-all duration-300">
            <Button
              isIconOnly
              radius="full"
              variant="flat"
        ...
        <div className="p-6 flex flex-col flex-grow space-y-3">
          ...
          <div className="pt-2">
            <Button
              ...
              className="font-bold h-14 rounded-2xl bg-primary/10 hover:bg-primary hover:text-primary-foreground transition-all duration-300"
