...
import { Check, Zap, Database, Cloud, Globe, Plug, Save, Lock } from "lucide-react";

const specs = [
  { icon: Check, title: "99.9% Uptime SLA", description: "Guaranteed availability" },
  { icon: Zap, title: "< 2s Cold Start", description: "Instant wake from idle" },
  { icon: Database, title: "Neon Serverless PostgreSQL", description: "Auto-scaling database" },
  { icon: Cloud, title: "Google Cloud Run", description: "Container-based compute" },
